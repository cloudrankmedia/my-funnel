...
const FAQS = [
  ...
  },
  {
    ...
    a: "Yes — SiteFlow Network operates nationwide across the United States. Whether your project is in a major metro or a rural corridor, we have certified providers available to serve you.",
  },
  {
          ...
          {FAQS.map(({ q, a }, i) => (
            <div key={q} className="border-b border-gray-200">
              ...
              >
                ...
                <span
                  className={`flex-shrink-0 w-6 h-6 rounded-full border border-gray-300 flex items-center justify-center text-gray-400 transition-transform duration-200 ${
